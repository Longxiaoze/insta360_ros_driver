...
public:
    ...
    int run_camera() {
        ...
        param.video_resolution = ins_camera::VideoResolution::RES_3840_3840P30; //Change this line to edit the resolution
        param.lrv_video_resulution = ins_camera::VideoResolution::RES_3840_3840P30;
        // ins_camera::VideoResolution::RES_3840_1920P30; //Change this line to edit the resolution
